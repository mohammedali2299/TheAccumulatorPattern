...
def run_test_sum_more_cosines():
    ...
    # ------------------------------------------------------------------
    # TOdoneDO: 2. Implement this TEST function.
    ...
    answer = math.cos(0) + math.cos(1) + math.cos(2) + math.cos(3)
...
def run_test_count_sines_from():
    ...
    # ------------------------------------------------------------------
    # TdoneODO: 4. Implement this TEST function.
...
def count_sines_from(m, n):
    ...
    # ------------------------------------------------------------------
    # TOdoneDO: 5. Implement and test this function.
    #   Note that you should write its TEST function first (above).
    #
